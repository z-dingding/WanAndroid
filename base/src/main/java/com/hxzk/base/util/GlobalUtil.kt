...
object GlobalUtil {
    ...
    val appPackage: String
        get() = Common.getContext().packageName
     ...
     */
    val appName: String
        get() = Common.getContext().resources.getString(Common.getContext().applicationInfo.labelRes)
    ...
    val appVersionName: String
        get() = Common.getContext().packageManager.getPackageInfo(appPackage, 0).versionName
    ...
    val appVersionCode: Int
        get() = Common.getContext().packageManager.getPackageInfo(appPackage, 0).versionCode
    ...
    fun getString(resId: Int): String {
        return Common.getContext().resources.getString(resId)
    }
    ...
    fun getResourceId(name: String, type: String): Int {
        return Common.getContext().resources.getIdentifier(name, type, appPackage)
    }
    ...
    fun getApplicationMetaData(key: String): String? {
        ...
        try {
            applicationInfo = Common.getContext().packageManager.getApplicationInfo(appPackage, PackageManager.GET_META_DATA)
    ...
    fun isInstalled(packageName: String): Boolean {
        val packageInfo: PackageInfo? = try {
            Common.getContext().packageManager.getPackageInfo(packageName, 0)
        } catch (e: PackageManager.NameNotFoundException) {
            null
        }
    ...
    fun getAppIcon(): Drawable {
        val packageManager = Common.getContext().packageManager
